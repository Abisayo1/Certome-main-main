...
const Prices = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-24 py-16 px-4 md:px-12 lg:px-44 min-h-screen flex items-center justify-center">

      {Plans.map((data,index) => (
        <div className=' first:bg-[#e010660d] bg-[#467eff0d] last:bg-[#89eb670d] shadow-lg max-lg:mx-auto p-5 ' key={index}>
