  ...
  return (
    <div className="sm:p-5 text-center m-3 sm:mt-3 sm:mb-20">
      ...
      <div className="flex flex-wrap max-md:justify-center items-center overflow-x-auto gap-3 mb-5 max-w-full">
        <button className="outline-none py-2 px-4 rounded-3xl bg-blue border-2 border-[#797979] cursor-pointer duration-300 focus:text-white focus:font-semibold focus:bg-blue-500">
          All
        </button>
        <button className="outline-none py-2 px-4 rounded-3xl bg-white border-2 border-[#797979] cursor-pointer duration-300 focus:text-black focus:font-semibold focus:bg-blue-500 min-w-[150px] sm:min-w-[200px]">
          Design Thinking
        </button>
        <button className="outline-none py-2 px-4 rounded-3xl bg-white border-2 border-[#797979] cursor-pointer duration-300 focus:text-black focus:font-semibold focus:bg-blue-500">
          Technology
        </button>
        <button className="outline-none py-2 px-4 rounded-3xl bg-white border-2 border-[#797979] cursor-pointer duration-300 focus:text-black focus:font-semibold focus:bg-blue-500">
          Web3
