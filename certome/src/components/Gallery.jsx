...
const Gallery = () => {
  ...
  const posts = [
    ...
    },
    {
      id: 2,
      imageUrl: 'imageb.png',
      title: 'The Evolution of Artificial Intelligence: Trends and Future Prospects',
      thumbnailUrl: 'imgIcon.jpg',
      name: 'Abisayo FA',
  ...
  return (
    <div className="lg:px-[10%] p-5 mx-auto lg:mx-16 ">
      ...
      <div className="my-10 text-center ">
        <button onClick={() => setOpen(!open)} className="shadow-lg px-3 py-2 border rounded-xl outline-none ">
          View {open ? 'Less' : 'More'} Posts
        </button>
      </div>
    </div>
  );
